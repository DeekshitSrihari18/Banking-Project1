...
<br/><br/><br/><br/>
	<div class="container">
			<form>
				<br/><br/><h3 align="center">Enter Customer Id to Delete</h3>
				<br/><br/>
				<h4>Customer ID : </h4><br/>
				<input type="text" placeholder="customerId" id="customerId" name="customerId"><br/></br></br>
				<input type="submit" value="Delete" formaction="DeleteCustomerByIdController" class="btn btn-warning"><br/><br/>
