	...
	<div>
			<form>
				...
				<input type="submit" value="WithDraw Amount" formaction="WithdrawForm.jsp" class="btn btn-success"><br/>
				 ...
				 <div class="col-12">
					 <br/>
				<input type="submit" value="Deposit Amount" formaction="DepositForm.jsp" class="btn btn-success"><br/>
				</div>
				 <div class="col-12">
					 <br/>
				<input type="submit" value="Transfer Amount To Account" formaction="TransferAmount.jsp" class="btn btn-success"><br/><br/><br/>
				</div>
				 <div class="col-12">
					 <br/>
