...
<body class="bg-color">
	...
	<table cellpadding="10" cellspacing="10">
		...
		<tr>
			...
			<td><a href="DeleteCustomerController?customerId=<%= customer.getCustomerId() %>" class="btn btn-warning">Delete</a></td>
		</tr>
		<%
		}
		%>
...
<a href="EmployeeDisplay.jsp" class="btn btn-secondary">Back</a>
</body>
</html>